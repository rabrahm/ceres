...
def FileClassify(dir, log,binning):
	...
	if dump == False and h[0].header['BINNING']==binning:
		if h[0].header['EXPTYPE'] == 'Object':
		    ...
		    if archivo == '/data/echelle/pfs/raw/20140206/pfs0279.fits' or archivo == '/data/echelle/pfs/raw/20140206/pfs0278.fits':
			obname = 'HATS554-024'
		    ra      = h[0].header['RA']
...
def mjd_fromheader(h):
    ...
    mjd0,mjd,i = BaryCor.iau_cal2jd(int(datetu[0:4]),int(datetu[5:7]),int(datetu[8:]))
